...
def getFunctionDetails(a):
    # [name, lb, ub, dim]
    param = {
        "f{}".format(i): ["f{}".format(i), -100, 100, 30] for i in range(30)
    ...
    for i in range(1, 24):
        param['F{}'.format(i)] = param_1['F{}'.format(i)]
    param['f_String'] = ["f_String", [0.05, 0.25, 2.00], [2.00, 1.30, 15.0], 3]
    param['f_Himmelblau'] = ['f_Himmelblau', [78 , 33, 27, 27, 27], [102, 45, 45, 45, 45], 5]
